...
function lib:AddTab(name)
	...
	newFrame.AutomaticCanvasSize = Enum.AutomaticSize.Y
	newFrame.BorderSizePixel = 0
	newFrame.Position = Menu.Position
	newFrame.Size = Menu.Size
	newFrame.CanvasSize = UDim2.new(0, 0, 0, 0)
	newFrame.ScrollBarImageColor3 = Color3.fromRGB(255, 255, 255)
	newFrame.ScrollBarThickness = Menu.ScrollBarThickness
