...
local UICorner_SliderValueBox = Instance.new("UICorner")
...
Menu.Size = UDim2.new(0.95, 0, 0.68, 0)
...
SliderValueBox.Name = "ValueBox"
SliderValueBox.Parent = Slider
SliderValueBox.AnchorPoint = Vector2.new(0, 0.5)
SliderValueBox.BackgroundColor3 = Color3.fromRGB(38, 38, 38)
SliderValueBox.BorderSizePixel = 0
SliderValueBox.Position = UDim2.new(0.03, 0, 0.5, 0)
SliderValueBox.Size = UDim2.new(0.2, 0, 0.6, 0)
SliderValueBox.Font = Enum.Font.TitilliumWeb
SliderValueBox.Text = "0"
SliderValueBox.TextColor3 = Color3.fromRGB(255, 255, 255)
SliderValueBox.TextScaled = true
SliderValueBox.TextSize = 14
SliderValueBox.ClearTextOnFocus = false
SliderValueBox.ZIndex = 2

UICorner_SliderValueBox.CornerRadius = UDim.new(0.4, 0)
UICorner_SliderValueBox.Parent = SliderValueBox
...
SliderLabel.Position = UDim2.new(0.26, 0, 0.05, 0)
SliderLabel.Size = UDim2.new(0.7, 0, 0.4, 0)
...
SliderBarHolder.Position = UDim2.new(0.26, 0, 0.9, 0)
SliderBarHolder.Size = UDim2.new(0.7, 0, 0.22, 0)
...
function lib:AddSlider(name, min, max, default, funct, tabName, ...)
	...
	local ValBox = newSlider:WaitForChild("ValueBox")
